    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/leaverequest/request").hasAnyRole("ADMIN", "TEACHER")
                .requestMatchers("/leaverequest/cancel/**").hasAnyRole("ADMIN", "TEACHER")
                .requestMatchers("/leaverequest/requestsbycni/**").hasAnyRole("ADMIN", "TEACHER", "RH")
                .requestMatchers("/leaverequest/process/**").hasRole("RH")
                .requestMatchers("/leaverequest/all").hasRole("RH")
                .requestMatchers("/contrat/**").hasRole("RH")
                .requestMatchers("/resignationrequest/request").hasAnyRole("ADMIN", "TEACHER")
                .requestMatchers("/resignationrequest/cancel/**").hasAnyRole("ADMIN", "TEACHER")
                .requestMatchers("/resignationrequest/requestsbycni/**").hasAnyRole("ADMIN", "TEACHER", "RH")
                .requestMatchers("/resignationrequest/process/**").hasRole("RH")
                .requestMatchers("/resignationrequest/all").hasRole("RH")
